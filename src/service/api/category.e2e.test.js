...
// mockDB - тестовая БД. Хранится в оперативной памяти. Логирование запросов отключили.
const mockDB = new Sequelize(`sqlite::memory:`, {logging: false});

// Глобальная функция express() инициализирует новое веб-приложение.
// т.е. HTTP-сервер для обработки входящих запросов пользователей.
const app = express();
